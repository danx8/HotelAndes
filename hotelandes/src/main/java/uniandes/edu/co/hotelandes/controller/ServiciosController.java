...
public class ServiciosController {
    ...
    public String servicioGuardar(@ModelAttribute Servicio servicio) {
        servicioRepository.insertServicio(servicio.getHorario_de_servicio(), servicio.getCosto(), servicio.getTipo());
    ...
    public String servicioEditarGuardar(@PathVariable("id") Integer id, @ModelAttribute Servicio servicio) {
        servicioRepository.updateServicio(id, servicio.getHorario_de_servicio(), servicio.getCosto(), servicio.getTipo());
        return "redirect:/servicios";
    }
